...
const SignUpForm = () => {
    ...
    const inputStyles = "leading-8 py-3 mt-1 bg-gray-600 block w-full rounded-sm border-gray-400 pl-7 pr-12 focus:border-black-500 focus:ring-black-500 sm:text-sm"
        ...
        <div>
            <div>
                ...
                <form className="lg:w-2/3 mt-10  mx-auto text-white " >
                    ...
                    {/* Email Input */}
                    <label htmlFor="price" className="block text-lg font-medium text-gray-200 mt-2">Email</label>
                    ...
                    {/* Message Input */}
                    <label htmlFor="message" className="block text-lg font-medium text-gray-200 mt-2">Message</label>
