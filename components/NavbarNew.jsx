...
export default function NavbarNew() {
  ...
  const navigation = [
    ...
    { name: "Blog", href: "/blog", current: router.pathname == "/blog" },
    {
      name: "Admin",
      href: "/admin",
      current: router.pathname.includes("/admin")
    },
    { name: "About", href: "/about", current: router.pathname == "/about" },
    {
      name: "Exercise",
      href: "/exercise",
      current: router.pathname == "/exercise"
    },
    {
      name: "Relationship",
      href: "/relationship",
      current: router.pathname == "/relationship"
    },
  ...
  return (
    <Disclosure as="nav" className="w-screen mx-auto">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-full px-2 py-8 sm:px-6 lg:px-44">
                    ...
                    {navigation.map(item => (
                      <p
                        ...
                        className={classNames(
                          item.current
                            ? "bg-none font-bold text-white opacity-20"
