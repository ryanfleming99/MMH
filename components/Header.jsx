...
const Header = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 px-6 min-h-screen md:h-content w-full md:w-10/12 mx-auto text-left items-center">
      <motion.div
      ...
      >
        <div className="flex flex-col justify-start">
          ...
          <h2 className="text-white my-2 text-base">
            ...
            voluptatem deserunt doloribus pariatur architecto odit non repellat
            accusantium esse animi, cum delectus, modi neque nostrum repellendus
            dolores voluptas fuga alias?
          </h2>
          <br />
          <button
            type="button"
            className="border sm:w-48 md:w-56 lg:w-64 xl:w-72 sm:text-lg md:text-xl font-semibold py-4 border-gray-200 bg-btngray text-gray-700 rounded-md transition duration-500 ease select-none hover:bg-gray-300 hover:scale-110 focus:scale-90 focus:outline-none focus:shadow-outline"
          >
            Learn More
          </button>
        </div>
