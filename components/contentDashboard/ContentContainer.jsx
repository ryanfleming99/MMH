  ...
  return (
    <div className="mx-auto max-w-screen bg-mainbg text-white min-h-screen">
      <div className="mx-auto max-w-6xl bg-mainbg">
        <div>
          <h1 className="pt-12 text-center text-white font-bold text-5xl lg:text-6xl md:text-5xl ">
            {" "}
            {category} Articles
          </h1>
          <p className="text-gray-300 text-center pt-12 mx-auto w-4/5 lg:w-3/5">
            ...
            sed sed turpis in cursus. A tempor faucibus arcu lacus porta auctor
            tempus id purus.
          </p>
        </div>
            ...
            return (
              ...
              >
                <Link href={`/content/${category.toLowerCase()}/${post.id}`}>
                  ...
                  <h3 className="text-white text-center font-semibold text-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    {post.title}
                  </h3>
                </Link>
              </motion.div>
