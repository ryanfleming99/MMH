...
const index = ({ id }) => {
    ...
    return (
        <div className=" mx-auto max-w-screen p-3 lg:px bg-gray-800 min-h-screen ">
            ...
            <div className="grid grid-cols-2 mx-auto w-full lg:w-8/12 items-center mt-12">
                {post.affiliateProducts?.map(product => (
                    <div key={uuidv4()} className="mx-auto">
                        <Link href={product.productLink}>
                            ...
                            <img className="mx-auto h-[150px] w-[150px] lg:h-[250px] lg:w-[250px]" src={product.imageLink} alt="" />
                        </Link>
                    </div>
                ))}
            </div>
